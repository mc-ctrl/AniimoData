...
slot4 = function(slot0, slot1)
	...
	if slot1 == "LevelMsgTriggerSheep2" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	if slot1 == "LevelMsgTriggerYe2" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if slot1 == "LevelMsgTriggerSheep3" then
	JUMP TO BLOCK #5
	else
	JUMP TO BLOCK #6
	end
	...
	if slot1 == "LevelMsgTriggerYe3" then
	JUMP TO BLOCK #7
	else
	JUMP TO BLOCK #8
	end
	...
	if slot1 == "LevelMsgTriggerSheepEnd" then
	JUMP TO BLOCK #9
	else
	JUMP TO BLOCK #10
	end
