...
slot4 = {
	"LevelMsgTriggerStartFightAfraid",
	"LevelMsgTriggerEndFightAfraid",
	"LevelMsgTriggerEndOutRangeAfraid",
	"LevelMsgTriggerStartOutRangeAfraid"
}
