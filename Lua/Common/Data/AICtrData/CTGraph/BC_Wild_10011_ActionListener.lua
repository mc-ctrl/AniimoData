...
slot4 = {
	"LevelMsgTriggerRoute1",
	"LevelMsgTriggerRoute2",
	"LevelMsgTriggerRoute3"
}
...
slot7 = function(slot0, slot1)
	...
	if slot1 == "LevelMsgTriggerRoute1" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	if slot1 == "LevelMsgTriggerRoute2" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if slot1 == "LevelMsgTriggerRoute3" then
	JUMP TO BLOCK #5
	else
	JUMP TO BLOCK #6
	end
