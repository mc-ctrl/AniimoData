...
slot4 = {
	"LevelMsgTriggerGoToFallenLeaves"
}
...
slot7 = function(slot0, slot1)
	...
	if slot1 == "LevelMsgTriggerGoToFallenLeaves" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
