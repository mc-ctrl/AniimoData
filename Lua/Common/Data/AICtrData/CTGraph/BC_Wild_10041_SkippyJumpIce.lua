...
slot3 = function(slot0, slot1)
	...
	if slot1 == "LevelMsgTrigger1JUMP" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	if slot1 == "LevelMsgTrigger2JUMP" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if slot1 == "LevelMsgTrigger3JUMP" then
	JUMP TO BLOCK #5
	else
	JUMP TO BLOCK #6
	end
	...
	if slot1 == "LevelMsgTriggerT1JUMP" then
	JUMP TO BLOCK #7
	else
	JUMP TO BLOCK #8
	end
	...
	if slot1 == "LevelMsgTriggerT2JUMP" then
	JUMP TO BLOCK #9
	else
	JUMP TO BLOCK #10
	end
	...
	if slot1 == "LevelMsgTriggerT3JUMP" then
	JUMP TO BLOCK #11
	else
	JUMP TO BLOCK #12
	end
