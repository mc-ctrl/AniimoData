...
slot4 = {
	"LevelMsgTrigger1HOME",
	"LevelMsgTrigger2HOME",
	"LevelMsgTrigger3HOME"
}
...
slot7 = function(slot0, slot1)
	...
	if slot1 == "LevelMsgTrigger1HOME" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	if slot1 == "LevelMsgTrigger2HOME" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if slot1 == "LevelMsgTrigger3HOME" then
	JUMP TO BLOCK #5
	else
	JUMP TO BLOCK #6
	end
