...
slot5 = function(slot0, slot1)
	...
	if slot1 == "LevelMsgTriggerActivate" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	if slot1 == "LevelMsgTriggerOff1" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if slot1 == "LevelMsgTriggerOff2" then
	JUMP TO BLOCK #5
	else
	JUMP TO BLOCK #6
	end
	...
	if slot1 == "LevelMsgTriggerOff3" then
	JUMP TO BLOCK #7
	else
	JUMP TO BLOCK #8
	end
	...
	if slot1 == "LevelMsgTriggerJump3" then
	JUMP TO BLOCK #13
	else
	JUMP TO BLOCK #14
	end
