...
slot4 = {
	"LevelMsgTriggerBC_Wild_10451_GuGuSisyphus_Rain"
}
...
slot7 = function(slot0, slot1)
	...
	if slot1 == "LevelMsgTriggerBC_Wild_10451_GuGuSisyphus_Rain" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
