...
slot4 = function(slot0, slot1)
	...
	if slot1 == "GBPMsg_ResPointJump" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	if slot1 == "GBPMsg_ResPointWatch" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if slot1 == "GBPMsg_ResPointGO2" then
	JUMP TO BLOCK #7
	else
	JUMP TO BLOCK #8
	end
	...
	if slot1 == "GBPMsg_ResPointGO3" then
	JUMP TO BLOCK #9
	else
	JUMP TO BLOCK #10
	end
