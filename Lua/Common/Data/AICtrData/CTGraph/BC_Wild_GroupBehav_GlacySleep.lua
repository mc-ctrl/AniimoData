...
slot5 = function(slot0, slot1)
	...
	if slot1 == "GBPMsg_CommonPlay1" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
	...
	if slot1 == "GBPMsg_CommonDoPatrol" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
	...
	if slot1 == "GBPMsg_CommonHappy1" then
	JUMP TO BLOCK #5
	else
	JUMP TO BLOCK #6
	end
	...
	if slot1 == "GBPMsg_CommonHappy2" then
	JUMP TO BLOCK #7
	else
	JUMP TO BLOCK #8
	end
	...
	if slot1 == "GBPMsg_CommonHappy" then
	JUMP TO BLOCK #9
	else
	JUMP TO BLOCK #10
	end
	...
	if slot1 == "GBPMsg_CommonPlay2" then
	JUMP TO BLOCK #11
	else
	JUMP TO BLOCK #12
	end
	...
	if slot1 == "GBPMsg_CommonPlay3" then
	JUMP TO BLOCK #13
	else
	JUMP TO BLOCK #14
	end
	...
	if slot1 == "GBPMsg_CommonCry" then
	JUMP TO BLOCK #15
	else
	JUMP TO BLOCK #16
	end
	...
	if slot1 == "GBPMsg_CommonLookAround" then
	JUMP TO BLOCK #17
	else
	JUMP TO BLOCK #18
	end
	...
	if slot1 == "GBPMsg_CommonBack2" then
	JUMP TO BLOCK #19
	else
	JUMP TO BLOCK #20
	end
	...
	if slot1 == "GBPMsg_CommonBack3" then
	JUMP TO BLOCK #21
	else
	JUMP TO BLOCK #22
	end
	...
	if slot1 == "GBPMsg_CommonBack1" then
	JUMP TO BLOCK #23
	else
	JUMP TO BLOCK #24
	end
	...
	if slot1 == "GBPMsg_CommonHappy3" then
	JUMP TO BLOCK #25
	else
	JUMP TO BLOCK #26
	end
	...
	if slot1 == "GBPMsg_CommonGlacyGoSleep" then
	JUMP TO BLOCK #27
	else
	JUMP TO BLOCK #28
	end
	...
	--- BLOCK #28 85-86, warpins: 2 ---
	--- END OF BLOCK #28 ---

	if slot1 == "GBPMsg_CommonGlacyWakeUp" then
	JUMP TO BLOCK #29
	else
	JUMP TO BLOCK #30
	end
...
slot5 = function(slot0)
	...
	slot1 = _B
	slot3 = slot0
	slot4 = "PBT_Behav_Com_IdlePatrol"
