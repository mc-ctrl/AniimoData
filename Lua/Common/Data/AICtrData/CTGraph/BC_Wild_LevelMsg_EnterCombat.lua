...
slot3 = function(slot0, slot1)
	...
	if slot1 == "LevelMsg_EnterCombat" then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
...
slot3 = function(slot0)
	...
	slot5 = "DoBehaviour"
	slot6 = slot0
	slot7 = "PBT_ReadyToFightwithoutQuestionMark"
