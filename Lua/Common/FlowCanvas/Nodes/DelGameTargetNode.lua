...
slot3 = function(slot0, slot1, slot2)
	...
	slot7 = slot5
	slot5 = slot5.debug
	slot8 = "@node DelGameTargetNode/On_In_PortCalled main player is nil  nodeId=%s graphId=%s"
	slot9 = slot0.nodeId
	slot10 = slot0.graph
	--- END OF BLOCK #5 ---
	...
	slot7 = slot5
	slot5 = slot5.info
	slot8 = "@node DelGameTargetNode/On_In_PortCalled gameTargetId=%s nodeId=%s graphId=%s"
	slot9 = slot3
	slot10 = slot0.nodeId
	slot11 = slot0.graph
	--- END OF BLOCK #8 ---
