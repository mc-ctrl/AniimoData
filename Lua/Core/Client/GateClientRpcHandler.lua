...
slot27 = function(slot0, slot1, slot2, slot3)
	...
	slot7 = slot5
	slot5 = slot5.error
	slot8 = "GateClientRpcHandler has no owner in ecsMessage"
	...
	slot8 = slot6
	slot6 = slot6.warn
	slot9 = "ecsMessage %s with targetId %s can not find targetEntity"
	slot10 = slot1
	...
	--- BLOCK #9 42-51, warpins: 3 ---
	slot8 = slot5
	slot6 = slot5.ecsMessage
	slot9 = ClientRepo
