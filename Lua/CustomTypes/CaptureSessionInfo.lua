...
slot4.getCaptureRuntimeTarget = slot5

slot5 = function(slot0, slot1, slot2)
	--- BLOCK #0 1-6, warpins: 1 ---
	slot3 = rawget
	slot5 = slot0
	slot6 = "captureRuntimeTargets"
...
slot4.addCaptureRuntimeTarget = slot5
